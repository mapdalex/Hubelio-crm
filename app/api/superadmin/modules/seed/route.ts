    ...
    const modules = [
      {
        ...
        features: ['dashboard', 'customers', 'contacts', 'todos', 'tickets', 'files'],
        basePrice: 0,
        status: 'ACTIVE',
        sortOrder: 1,
      },
      {
        ...
        icon: 'MessageSquare',
        features: ['email', 'inbox', 'templates', 'automation'],
        basePrice: 99,
        status: 'ACTIVE',
        sortOrder: 2,
      },
      {
        ...
        icon: 'ShoppingCart',
        features: ['domains', 'services', 'pricing', 'orders'],
        basePrice: 149,
        status: 'ACTIVE',
        sortOrder: 3,
      },
      {
        ...
        icon: 'Headphones',
        features: ['tickets', 'assets', 'computers', 'domains', 'knowledge_base', 'sla'],
        basePrice: 149,
        status: 'ACTIVE',
        sortOrder: 4,
      },
      {
        ...
        icon: 'Share2',
        features: ['accounts', 'posting', 'analytics', 'scheduling'],
        basePrice: 199,
        status: 'BETA',
        sortOrder: 5,
      },
      {
        ...
        icon: 'TrendingUp',
        features: ['campaign_builder', 'audience', 'tracking', 'reports'],
        basePrice: 249,
        status: 'BETA',
        sortOrder: 6,
      },
      {
        ...
        icon: 'BarChart3',
        features: ['dashboards', 'reports', 'export', 'insights'],
        basePrice: 299,
        status: 'ACTIVE',
        sortOrder: 7,
      },
